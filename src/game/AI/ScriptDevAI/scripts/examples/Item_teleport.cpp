...
bool GossipHello_ItemUse_Item_teleport(Player *player, Item* _Item, SpellCastTargets const& targets)
{
		...
		player->ADD_GOSSIP_ITEM( 0, " 野外BOSS传送 " , 1, GOSSIP_ACTION_INFO_DEF + 8);
...
void SendDefaultMenu_ItemUse_Item_teleport(Player *player, Item *_Item, uint32 action, SpellCastTargets const& targets)
{
	switch(action) {
		...
		case GOSSIP_ACTION_INFO_DEF + 1 :
			player->ADD_GOSSIP_ITEM( 7, " 返回到上一级选项菜单 " , 15, GOSSIP_ACTION_INFO_DEF + 99);
			player->ADD_GOSSIP_ITEM( 0, " [联盟] 暴风城 " , 2, GOSSIP_ACTION_INFO_DEF + 6);
			player->ADD_GOSSIP_ITEM( 0, " [联盟] 铁炉堡 " , 2, GOSSIP_ACTION_INFO_DEF + 7);
			player->ADD_GOSSIP_ITEM( 0, " [联盟] 达纳苏斯 " , 2, GOSSIP_ACTION_INFO_DEF + 8);
			player->ADD_GOSSIP_ITEM( 0, " [部落] 奥格瑞玛 " , 2, GOSSIP_ACTION_INFO_DEF + 10);
			player->ADD_GOSSIP_ITEM( 0, " [部落] 雷霆崖 " , 2, GOSSIP_ACTION_INFO_DEF + 11);
			player->ADD_GOSSIP_ITEM( 0, " [部落] 幽暗城 " , 2, GOSSIP_ACTION_INFO_DEF + 12);
			player->ADD_GOSSIP_ITEM( 0, " [中立] 棘齿城 " , 2, GOSSIP_ACTION_INFO_DEF + 14);
			player->ADD_GOSSIP_ITEM( 0, " [中立] 藏宝海湾 " , 2, GOSSIP_ACTION_INFO_DEF + 15);
