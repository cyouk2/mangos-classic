...
struct Script
{
    Script() :
        ...
        pEffectAuraDummy(nullptr), GetGameObjectAI(nullptr), GetAI(nullptr), GetInstanceData(nullptr), pGossipSelect_Item(nullptr)
    {}
	...
	bool (*pGossipSelect_Item)(Player*, Item*, uint32, uint32, SpellCastTargets const&);
